...
$(function(){ //자동 실행
	$("#btnEdit").click(function(){ //수정/삭제 버튼
		document.form1.action="/munch/board_servlet/check_pwd.do";
	...
	$("#btnReply").click(function(){ //답변 버튼
		document.form1.action="/munch/board_servlet/input_reply.do";
		document.form1.submit();
	});
});
